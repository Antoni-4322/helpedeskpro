...
class WorkDesk(models.Model):
    name = models.CharField(null=True, max_length=65)
...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    work_desk = models.ManyToManyField(WorkDesk, null=True)
    date_joined = models.DateTimeField(_('date joined'), default=timezone.now)
    image = models.ImageField(upload_to='user_image/%Y/%m', blank=True, null=True)
